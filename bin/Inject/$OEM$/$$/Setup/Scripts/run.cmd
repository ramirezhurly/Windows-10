...
echo.
echo   Digital License Office and Windows 10 Activation v8.8 - Hurly
echo.
...
set "_mO14c=Detected Office 2010 C2R Retail is not supported by KMS Suite"
set "_mO14m=Detected Office 2010 MSI Retail is not supported by KMS Suite"
set "_mO15m=Detected Office 2013 MSI Retail is not supported by KMS Suite"
set "_mO16m=Detected Office 2016 MSI Retail is not supported by KMS Suite"
set "_mOuwp=Detected Office 365/2016 UWP is not supported by KMS Suite"
...
if %Debug% EQU 0 (
  ...
  echo This window will close automatically when the process is finished. Please wait...
  TIMEOUT /T 4 >nul
  echo.
  echo "!_log!Debug.log"
  )
...
::===============================================================================================================
:win7off
if %loc_off19% EQU 0 if %loc_off16% EQU 0 if %loc_off15% EQU 0 if %loc_off14% EQU 0 (echo.&echo. &exit /b)
set Off1ce=1
set _sC2R=win7off
...
%EchoRed1% Product Activation Failed: 0xC004F035
...
%EchoRed1% Product Activation Failed: 0xC004F200
...
cmd /c exit /b %ERRORCODE%
if %ERRORCODE% NEQ 0 (
%EchoRed1% Product Activation Failed: 0x!=ExitCode!
) else (
%EchoRed1% Product Activation Failed
)
echo Remaining Period: %gpr2% days ^(%gpr% minutes^)
set S_OK=0
exit /b
...
::===============================================================================================================
:InstallHook
for %%# in (SppExtComObjHookAvrf.dll,KMS.dll,SppExtComObjHook.dll,SppExtComObjPatcher.dll,SppExtComObjPatcher.exe) do (
...
del /f /q C:\Windows\KMS\bin\cleanosppx64.exe >nul 2>&1 
del /f /q C:\Windows\KMS\bin\cleanosppx86.exe >nul 2>&1
